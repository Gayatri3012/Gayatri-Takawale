...
export default function About() {
    ...
    return (
        <section id="about" className="flex gap-2 mt-6">
            {/* <img src="/images/worldmap2.jpg" alt="" /> */}
            <p className="py-4  font-bold sm:text-4xl md:text-5xl lg:text-6xl text-4xl  text-black dark:text-white">Gayatri Takawale</p>
            ...
            <div className="flex justify-normal flex-col gap-8 sm:flex-col md:flex-row lg:flex-row">
                ...
                <div className="flex items-center lg:gap-4 gap-2 p-4 justify-end">
                    ...
                    target="_blank"
                    className="mt-1 px-2 py-1 bg-[#a48bd2] text-white text-xl rounded-lg"
                    >
                        Resume
                    </a>
                </div>
